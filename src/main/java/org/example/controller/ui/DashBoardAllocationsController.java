...
/**
 * Controller for the Allocations Dashboard
 * Extends BaseDashboardController to inherit navigation methods
 */
public class DashBoardAllocationsController extends BaseDashboardController implements Initializable {
    ...
    private void handleSearch() {
        // A busca já está implementada no setupSearch() com listener
        // Este método pode ser usado para busca manual se necessário
        String searchText = searchField.getText();
        if (searchText != null && !searchText.isEmpty()) {
            // A busca já funciona automaticamente através do FilteredList
