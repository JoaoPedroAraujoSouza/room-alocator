...
import org.example.view.AddPopUp.AddTeacherDialogController;
import org.example.view.EditPopUp.EditTeacherDialogController;
...
public class DashBoardTeacherController extends BaseDashboardController implements Initializable {
    ...
    public void CreateTeacher() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AddPopUp/AddTeacherDialog.fxml"));
    ...
    private void handleEditTeacher(Teacher teacher) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/EditPopUp/EditTeacherDialog.fxml"));
            Parent root = loader.load();
