...
import org.example.view.AddPopUp.AddClassroomDialogController;
import org.example.view.EditPopUp.EditClassroomDialogController;
...
public class DashBoardClassroomController extends BaseDashboardController implements Initializable {
    ...
    public void CreateClassroom() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AddPopUp/AddClassroomDialog.fxml"));
    ...
    private void handleEditClassroom(Classroom classroom) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/EditPopUp/EditClassroomDialog.fxml"));
            Parent root = loader.load();
