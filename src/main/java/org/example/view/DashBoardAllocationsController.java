...
import org.example.view.AddPopUp.AddAllocationDialogController;
import org.example.view.EditPopUp.EditAllocationDialogController;
...
public class DashBoardAllocationsController extends BaseDashboardController implements Initializable {
    ...
    private void showAllocationDialog(TimeAllocation allocation) {
        try {
            String fxmlFile = allocation == null ? "/fxml/AddPopUp/AddAllocationDialog.fxml" : "/fxml/EditPopUp/EditAllocationDialog.fxml";
