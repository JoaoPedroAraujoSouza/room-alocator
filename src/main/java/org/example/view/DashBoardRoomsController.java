...
import org.example.view.AddPopUp.AddRoomDialogController;
import org.example.view.EditPopUp.EditRoomDialogController;
...
public class DashBoardRoomsController extends BaseDashboardController implements Initializable {
    ...
    public void CreateRoom() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AddPopUp/AddRoomDialog.fxml"));
    ...
    private void editRoom(Room room) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/EditPopUp/EditRoomDialog.fxml"));
            Scene scene = new Scene(loader.load());
