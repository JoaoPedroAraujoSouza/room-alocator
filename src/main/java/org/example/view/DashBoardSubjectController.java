...
import org.example.view.AddPopUp.AddSubjectDialogController;
import org.example.view.AddPopUp.AddTeacherSubjectLinkDialogController;
import org.example.view.EditPopUp.EditSubjectDialogController;
import org.example.view.EditPopUp.EditTeacherSubjectLinkDialogController;
...
public class DashBoardSubjectController extends BaseDashboardController implements Initializable {
    ...
    private void handleAddSubject() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AddPopUp/AddSubjectDialog.fxml"));
    ...
    private void handleEditSubject(Subject subject) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/EditPopUp/EditSubjectDialog.fxml"));
            Scene scene = new Scene(loader.load());
    ...
    private void handleAddLink() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AddPopUp/AddTeacherSubjectLinkDialog.fxml"));
            Scene scene = new Scene(loader.load());
    ...
    private void handleEditLink() {
        if (selectedLink != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/EditPopUp/EditTeacherSubjectLinkDialog.fxml"));
                Scene scene = new Scene(loader.load());
